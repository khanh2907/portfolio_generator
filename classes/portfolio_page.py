					...
					with tag('div', klass='container'):
						...
						with tag('div', klass='projects col-md-12'):
							for project in projects:
								with tag('div', klass='project well col-md-12', id=project.friendly_name):
									with tag('div', klass='meta col-md-12'):
									# Project Title
										...
										# Videos
										if hasattr(project, 'video_embed'):
											with tag('div', klass='video_embed'):
									...
									if hasattr(project, 'urls'):
										with tag('div', klass='links-container col-md-6'):
											with tag('h3'):
												text('Links')
											with tag('ul'):
												for url in project.urls:
													with tag('li'):
														with tag('a', ('href', url)):
															text(url)
			with tag('footer', klass='centerize'):
				with tag('small', klass='outside'):
					text("Generated by ")
					with tag('a', ('href', 'https://github.com/khanh2907/portfolio_generator')):
						text("Portfolio Generator")
					text(" on %s." % (self.timestamp))
